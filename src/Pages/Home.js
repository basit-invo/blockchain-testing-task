...
const pop = {
  section: "pop",
  image: popImg,
  heading: "Proof of Passion - PoP",
  description:
    "You are just starting out? Grind your way to the top with Proof of Passion! PoP will allow yout to get into TIERs with passion. This will make sure more users can get a piece of the cake and enjoy the benefits of being in our tier structure",
  buttonText: "NFT Tier Q3",
};
